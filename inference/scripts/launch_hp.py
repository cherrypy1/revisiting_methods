...
``scripts/cosmos_hp_run.py`` with stdout/stderr redirected to a per-GPU log.

Usage:
    python scripts/launch_hp.py <gpu_idx> <tag> [method1 method2 ...]
"""
...
def main():
    ...
    cmd = [
        args.python,
        str(PROJECT_ROOT / "scripts" / "cosmos_hp_run.py"),
