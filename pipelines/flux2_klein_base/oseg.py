    ...
    def __call__(
        ...
        Args:
            ...
            seg_scale (`float`, *optional*, defaults to 0.0):
                Kept for compatibility with SEG configs. OSEG uses `oseg_scale` for the perturbation direction.
                    ...
                    if self.do_classifier_free_guidance and self.do_oseg:
                        noise_pred = (
                            ...
                            * (noise_pred_original - neg_noise_pred_perturb)
                            + self.oseg_scale * (noise_pred_original - noise_pred_perturb)
                        )
                        ...
                        noise_pred = noise_pred_original + self.oseg_scale * (
